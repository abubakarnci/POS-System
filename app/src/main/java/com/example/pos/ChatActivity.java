            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()){
                    ...
                    case R.id.menu_call:
                        ...
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Intent i= new Intent(ChatActivity.this,Dialer.class);
                        startActivity(i);
                        break;
                    ...
                    case R.id.menu_profile:
                        ...
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Intent j= new Intent(ChatActivity.this,Profile.class);
                        startActivity(j);
                        break;
                    ...
                    case R.id.menu_alarm:
                        ...
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Intent k= new Intent(ChatActivity.this,MainAlarm.class);
                        startActivity(k);
                        break;
